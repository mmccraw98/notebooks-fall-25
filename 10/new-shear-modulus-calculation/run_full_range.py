...
if __name__ == "__main__":
    i = 0
    root = f"/home/mmccraw/dev/data/10-15-25/new-shear-modulus-full-range/trial-{i}/"
    ...
    subprocess.run([
        ...
        init_path,
        init_path,
        str(100_000 // 2),  # total number of steps - half are used for compression, the other half are used for equilibration
        str(phi_increment),
        str(temperature),
        str(dt),
    ], check=True)
    ...
    while True:
        ...
        subprocess.run([
            ...
            compression_path,
            compression_path,
            str(int(1_000_000 / 2)),  # total number of steps - half are used for compression, the other half are used for equilibration
            str(phi_increment),
            str(temperature),
            str(dt),
        ], check=True)
