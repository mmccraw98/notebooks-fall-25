...
if __name__ == "__main__":
    ...
    for i in range(10):
        for name, n_particles, n_duplicates in zip(['small', 'large'], [10, 100], [1, 1]):
            for nv in [10, 20, 3, 6, 30]:
                for mu_eff in [1.0, 0.5, 0.01, 0.05, 0.1, 1.5]:
                    root = f"/home/mmccraw/dev/data/10-14-25/effective-potential/jamming-{name}/rb-{nv}-{mu_eff:.2f}/"
